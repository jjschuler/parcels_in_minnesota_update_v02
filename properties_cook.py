...
def createCountyObj():
    ...
    countyObj.county_name = 'Cook'
    countyObj.cty_fips = r'31'
    countyObj.county_id = r'031'
    countyObj.cty_abbr = r'COOK'
    countyObj.mngeo_web_id = r'Cook 031'
    countyObj.sourceZipFile = r'COOK_parcels.zip'
    countyObj.sourcePolygons = r'CookCountyTaxParcels.shp'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['PARCELNBR']
    ...
    countyObj.BLOCK_fieldList = ['BLOCKNBR']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['LOTNBR']
    countyObj.LOT_transferType = 'defaultTransfer'
    countyObj.ACRES_POLY_fieldList = ['Calculated']
    countyObj.ACRES_DEED_fieldList = ['DEEDEDACRE']
    countyObj.USE1_DESC_fieldList = ['ACCLDS1']
    countyObj.USE1_DESC_transferType = 'defaultTransfer'
    countyObj.USE2_DESC_fieldList = ['ACCLDS2']
    countyObj.USE2_DESC_transferType = 'defaultTransfer'
    countyObj.USE3_DESC_fieldList = ['ACCLDS3']
    ...
    countyObj.OWNER_NAME_fieldList = ['OWNNAME']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['OWNADR1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['OWNADR2']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['OWNADR3']
    countyObj.OWN_ADD_L3_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L4_fieldList = ['OWNADR4', 'OWNZIP5']
    ...
    countyObj.TAX_ADD_L1_fieldList = ['TAXADR1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TAXADR2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['TAXADR3']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['TAXADR4', 'TAXZIP5']
    countyObj.TAX_ADD_L4_transferType = 'concatTruncateTwoFields'
    countyObj.OWNERSHIP_fieldList = ['OWNTYPE']
    ...
    countyObj.EMV_LAND_fieldList = ['LANDEST']
    ...
    countyObj.SECTION_fieldList = ['SEC']
    countyObj.TOWNSHIP_fieldList = ['TWP']
    countyObj.RANGE_fieldList = ['RGE']
    countyObj.RANGE_DIR_fieldList = ['DIR']
    countyObj.LEGAL_DESC_fieldList = ['DSDESC']
    ...
    countyObj.ORIG_PIN_fieldList = ['PARCELNBR']
