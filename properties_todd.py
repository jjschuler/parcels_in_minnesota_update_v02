...
def createCountyObj():
    ...
    countyObj.county_name = 'Todd'
    countyObj.cty_fips = r'153'
    countyObj.county_id = r'153'
    countyObj.cty_abbr = r'TODD'
    countyObj.mngeo_web_id = r'Todd 153'
    countyObj.sourceZipFile = r'TODD_parcels.zip'
    countyObj.sourcePolygons = r'Todd_Parcels.shp'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['par_id']
    ...
    countyObj.EMV_LAND_fieldList = ['AVLAND']
    countyObj.EMV_BLDG_fieldList = ['AVBLDG']
    countyObj.EMV_TOTAL_fieldList = ['AVTOTL']
    ...
    countyObj.SECTION_fieldList = ['PLSSEC']
    countyObj.TOWNSHIP_fieldList = ['PLSTWP']
    countyObj.RANGE_fieldList = ['PLSRNG']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['LEGAL1', 'LEGAL2'] #TODO - MORE LEGAL TO ADD IN
    ...
    countyObj.ORIG_PIN_fieldList = ['par_id']
