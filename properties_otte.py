...
def createCountyObj():
    ...
    countyObj.county_name = 'Otter Tail'
    countyObj.cty_fips = r'111'
    countyObj.county_id = r'111'
    countyObj.cty_abbr = r'OTTE'
    countyObj.mngeo_web_id = r'Otter Tail 111'
    countyObj.sourceZipFile = r'OTTE_parcels.zip'
    countyObj.sourcePolygons = r'county.shp'
