...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Clay'
        self.cty_fips = r'27'
        self.county_id = r'027'
        self.cty_abbr = r'CLAY'
        self.mngeo_web_id = r'Clay 027'
        self.sourceZipFile = r'CLAY_parcels.zip'
        self.sourcePolygons = r'Clay_County_Parcels.shp'
        ...
        self.ACRES_POLY_exists.fieldTransferList = ['CALC_ACREA']
        ...
        self.TAX_NAME_exists.fieldTransferList = ['TAX_NAME']
        self.TAX_NAME_exists.transferType = ''
        self.TAX_ADD_L1_exists.fieldTransferList = ['TAX_ADD_L1']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['TAX_ADD_L2', 'TAX_ADD_L3', 'TAX_ADD_L4']
        self.TAX_ADD_L2_exists.transferType = 'concatTruncateTwoFields'
        ...
        self.SPEC_ASSES_exists.fieldTransferList = ['SPEC_ASSES']
        ...
        self.WSHD_DIST_exists.fieldTransferList = ['WSHD_DIST']
        self.WSHD_DIST_exists.transferType = ''
        self.GREEN_ACRE_exists.fieldTransferList = ['GREEN_ACRE']
        self.GREEN_ACRE_exists.transferType = ''
        self.OPEN_SPACE_exists.fieldTransferList = []
        self.OPEN_SPACE_exists.transferType = ''
        self.AG_PRESERV_exists.fieldTransferList = ['AG_PRESERV']
        ...
        self.SECTION_exists.fieldTransferList = ['SectionNum']
        self.TOWNSHIP_exists.fieldTransferList = []
        self.RANGE_exists.fieldTransferList = ['RangeNumbe']
