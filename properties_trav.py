...
def createCountyObj():
    ...
    countyObj.county_name = 'Traverse'
    countyObj.cty_fips = r'155'
    countyObj.county_id = r'155'
    countyObj.cty_abbr = r'TRAV'
    countyObj.mngeo_web_id = r'Traverse 155'
    countyObj.sourceZipFile = r'TRAV_parcels.zip'
