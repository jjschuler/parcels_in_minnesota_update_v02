...
def createCountyObj():
    ...
    countyObj.county_name = 'Rock'
    countyObj.cty_fips = r'133'
    countyObj.county_id = r'133'
    countyObj.cty_abbr = r'ROCK'
    countyObj.mngeo_web_id = r'Rock 133'
    countyObj.sourceZipFile = r'ROCK_parcels.zip'
    ...
    countyObj.OWN_ADD_L4_fieldList = ['OWCITY', 'OWSTATE', 'OWZIPF']
    ...
    countyObj.EMV_TOTAL_fieldList = ['AVTMKT']
