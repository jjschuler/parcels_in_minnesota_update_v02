...
def createCountyObj():
    ...
    countyObj.county_name = 'Crow Wing'
    countyObj.cty_fips = r'35'
    countyObj.county_id = r'035'
    countyObj.cty_abbr = r'CROW'
    countyObj.mngeo_web_id = r'Crow Wing 035'
    countyObj.sourceZipFile = r'CROW.zip'
    countyObj.sourcePolygons = r'WednesdayBackup.gdb\ParcelsTaxData'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['APPRCL']
    ...
    countyObj.ACRES_DEED_fieldList = ['APDEED']
    ...
    countyObj.MARKET_YEAR_fieldList = ['ASMT_YR']
    countyObj.EMV_LAND_fieldList = ['TPLAND']
    countyObj.EMV_BLDG_fieldList = ['TPBLDG']
    ...
    countyObj.ORIG_PIN_fieldList = ['APPRCL']
