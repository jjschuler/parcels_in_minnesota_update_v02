...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Crow Wing'
        self.cty_fips = r'35'
        self.county_id = r'035'
        self.cty_abbr = r'CROW'
        self.mngeo_web_id = r'Crow Wing 035'
        self.sourceZipFile = r'CROW.zip'
        self.sourcePolygons = r'WednesdayBackup.gdb\ParcelsTaxData'
        self.sourceOwnershipZipFile = r''
        self.sourceOwnershipTable = r''
        self.joinInField = r''
        self.joinJoinField = r''
        self.PIN_exists.fieldTransferList = ['APPRCL']
        ...
        self.ACRES_DEED_exists.fieldTransferList = ['APDEED']
        self.USE1_DESC_exists.fieldTransferList = ['TPCLS1']
        self.USE1_DESC_exists.transferType = ''
        self.USE2_DESC_exists.fieldTransferList = ['TPCLS2']
        self.USE2_DESC_exists.transferType = ''
        self.USE3_DESC_exists.fieldTransferList = ['TPCLS3']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['OWNAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = []
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['OWADR1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['OWADR2']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['OWADR3']
        self.OWN_ADD_L3_exists.transferType = ''
        self.OWN_ADD_L4_exists.fieldTransferList = ['OWADR4']
        self.OWN_ADD_L4_exists.transferType = ''
        self.TAX_NAME_exists.fieldTransferList = ['TXNAME']
        self.TAX_NAME_exists.transferType = ''
        self.TAX_ADD_L1_exists.fieldTransferList = ['TXADR1']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['TXADR2']
        self.TAX_ADD_L2_exists.transferType = ''
        self.TAX_ADD_L3_exists.fieldTransferList = ['TXADR3']
        self.TAX_ADD_L3_exists.transferType = ''
        self.TAX_ADD_L4_exists.fieldTransferList = ['TXADR4']
        self.TAX_ADD_L4_exists.transferType = ''
        self.OWNERSHIP_exists.fieldTransferList = []
        self.OWNERSHIP_exists.transferType = ''
        self.HOMESTEAD_exists.fieldTransferList = ['TPHSTC']
        self.HOMESTEAD_exists.transferType = ''
        self.TAX_YEAR_exists.fieldTransferList = []
        self.MARKET_YEAR_exists.fieldTransferList = ['ASMT_YR']
        self.EMV_LAND_exists.fieldTransferList = ['TPLAND']
        self.EMV_BLDG_exists.fieldTransferList = ['TPBLDG']
        self.EMV_TOTAL_exists.fieldTransferList = ['ESTTOTVAL']
        ...
        self.SECTION_exists.fieldTransferList = ['APSECT']
        self.TOWNSHIP_exists.fieldTransferList = ['APTOWN']
        self.RANGE_exists.fieldTransferList = ['APRANG']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['LEGAL']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['APPRCL']
