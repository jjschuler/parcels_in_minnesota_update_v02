...
def createCountyObj():
    ...
    countyObj.county_name = 'Dodge'
    countyObj.cty_fips = r'39'
    countyObj.county_id = r'039'
    countyObj.cty_abbr = r'DODG'
    countyObj.mngeo_web_id = r'Dodge 039'
    countyObj.sourceZipFile = r'DODG_parcels.zip'
    countyObj.sourcePolygons = r'dodge.gdb\Parcels'
    ...
    countyObj.BLDG_NUM_fieldList = ['C0HSENO1']
    ...
    countyObj.OWNER_NAME_fieldList = ['C0NAME1P']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = ['C0NAME2P']
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['C0ADRLN1P']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['C0ADRLN2P']
    countyObj.OWN_ADD_L2_transferType = ''
    countyObj.OWN_ADD_L3_fieldList = ['C0ADRLN3P']
    countyObj.OWN_ADD_L3_transferType = ''
    countyObj.OWN_ADD_L4_fieldList = ['C0CITYP', 'C0STATEP', 'C0ZIPCD6P']
    ...
    countyObj.SCHOOL_DST_fieldList = ['C0ENTDSC']
    ...
    countyObj.SECTION_fieldList = ['C0SECTN']
    countyObj.TOWNSHIP_fieldList = ['C0TWNSHP']
    countyObj.RANGE_fieldList = ['C0RANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['SHORTLEGAL']
