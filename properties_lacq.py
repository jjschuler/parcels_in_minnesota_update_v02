...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Lac qui Parle'
        self.cty_fips = r'73'
        self.county_id = r'073'
        self.cty_abbr = r'LACQ'
        self.mngeo_web_id = r'Lac qui Parle 073'
        self.sourceZipFile = r'LACQ_parcels.zip'
        ...
        self.PLAT_NAME_exists.fieldTransferList = ['PLATDESC']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['OWNERNAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = []
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['OWNERADD1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['OWNERADD2']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['OWNERADD3']
        self.OWN_ADD_L3_exists.transferType = ''
        self.OWN_ADD_L4_exists.fieldTransferList = ['OWNERADD4', 'OWNERZIP']
        ...
        self.LEGAL_DESC_exists.fieldTransferList = ['DESC101', 'DESC102']
