...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Washington'
        self.cty_fips = r'163'
        self.county_id = r'163'
        self.cty_abbr = r'WASH'
        self.mngeo_web_id = r'Washington 163'
        self.sourceZipFile = r'WASH_parcels.zip'
        self.sourcePolygons = r'WCWebdata.gdb\TaxParcel'
