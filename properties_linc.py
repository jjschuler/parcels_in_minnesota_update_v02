...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Lincoln'
        self.cty_fips = r'81'
        self.county_id = r'081'
        self.cty_abbr = r'LINC'
        self.mngeo_web_id = r'Lincoln 081'
        self.sourceZipFile = r'LINC_parcels.zip'
        self.sourcePolygons = r'parcels_12232013.shp'
