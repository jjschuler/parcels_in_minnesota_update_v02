...
def createCountyObj():
    ...
    countyObj.county_name = 'Lincoln'
    countyObj.cty_fips = r'81'
    countyObj.county_id = r'081'
    countyObj.cty_abbr = r'LINC'
    countyObj.mngeo_web_id = r'Lincoln 081'
    countyObj.sourceZipFile = r'LINC_parcels.zip'
    countyObj.sourcePolygons = r'parcels_12232013.shp'
    ...
    countyObj.PLAT_NAME_fieldList = ['ADDITION']
    ...
    countyObj.ACRES_POLY_fieldList = ['CALC_ACRES']
    ...
    countyObj.OWNER_NAME_fieldList = ['O_NAME1']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = ['O_NAME2']
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['O_ADD1']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['O_ADD2']
    countyObj.OWN_ADD_L2_transferType = ''
    countyObj.OWN_ADD_L3_fieldList = ['O_CITY', 'O_STATE', 'O_ZIP']
    ...
    countyObj.TAX_NAME_fieldList = ['TP_NAME1', 'TP_NAME2']
    countyObj.TAX_NAME_transferType = 'concatTruncateTwoFields'
    countyObj.TAX_ADD_L1_fieldList = ['TP_ADD1']
    countyObj.TAX_ADD_L1_transferType = ''
    countyObj.TAX_ADD_L2_fieldList = ['TP_ADD2']
    countyObj.TAX_ADD_L2_transferType = ''
    countyObj.TAX_ADD_L3_fieldList = ['TP_CITY', 'TP_STATE', 'TP_ZIP']
    ...
    countyObj.LEGAL_DESC_fieldList = ['LEGDES1', 'LEGDES2'] #TODO - ADD 'LEGDES3'
