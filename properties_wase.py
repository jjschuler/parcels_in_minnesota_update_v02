...
def createCountyObj():
    ...
    countyObj.county_name = 'Waseca'
    countyObj.cty_fips = r'161'
    countyObj.county_id = r'161'
    countyObj.cty_abbr = r'WASE'
    countyObj.mngeo_web_id = r'Waseca 161'
    countyObj.sourceZipFile = r''
    countyObj.sourcePolygons = r'plan_parcels.gdb\TaxParcels'
    ...
    countyObj.TAX_NAME_fieldList = ['TAXPAYNM1', 'TAXPAYNM2']
    countyObj.TAX_NAME_transferType = 'concatTruncateTwoFields'
    countyObj.TAX_ADD_L1_fieldList = ['TAXPAYADD1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TAXPAYADD2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['TAXPAYCI', 'TAXPAYST', 'TAXPAYZIP6']
    ...
    countyObj.TAX_YEAR_fieldList = ['TAXYR']
    ...
    countyObj.FIN_SQ_FT_fieldList = ['BLDGSQFT']
