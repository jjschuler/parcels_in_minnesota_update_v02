...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Rice'
        self.cty_fips = r'131'
        self.county_id = r'131'
        self.cty_abbr = r'RICE'
        self.mngeo_web_id = r'Rice 131'
        self.sourceZipFile = r'RICE.zip'
        self.sourcePolygons = r'Rice County.gdb\parcel'
