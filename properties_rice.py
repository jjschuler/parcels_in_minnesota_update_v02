...
def createCountyObj():
    ...
    countyObj.county_name = 'Rice'
    countyObj.cty_fips = r'131'
    countyObj.county_id = r'131'
    countyObj.cty_abbr = r'RICE'
    countyObj.mngeo_web_id = r'Rice 131'
    countyObj.sourceZipFile = r'RICE.zip'
    countyObj.sourcePolygons = r'Rice County.gdb\parcel'
    ...
    countyObj.BLDG_NUM_fieldList = ['STREETNUM']
    ...
    countyObj.PLAT_NAME_fieldList = ['GP_PLAT']
    countyObj.PLAT_NAME_transferType = 'defaultTransfer'
    countyObj.BLOCK_fieldList = ['GP_BLOCK']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['GP_LOT']
    countyObj.LOT_transferType = 'defaultTransfer'
    countyObj.ACRES_POLY_fieldList = ['GROSSACRES']
    countyObj.ACRES_DEED_fieldList = []
    countyObj.USE1_DESC_fieldList = ['CLASS']
    ...
    countyObj.USE4_DESC_fieldList = ['Class4']
    ...
    countyObj.OWNER_NAME_fieldList = ['DEEDHOLD']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['MAILADDR']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['MAILCITY', 'MAILSTATE', 'MAILZIP']
    ...
    countyObj.FIN_SQ_FT_fieldList = ['SQFT']
    ...
    countyObj.YEAR_BUILT_fieldList = ['YRBUILT']
    countyObj.NUM_UNITS_fieldList = []
    countyObj.SALE_DATE_fieldList = ['SALEDATE']
    countyObj.SALE_DATE_transferType = 'ToDate'
    countyObj.SALE_VALUE_fieldList = ['SaleValue']
    ...
    countyObj.SECTION_fieldList = ['GP_SECTION']
    countyObj.TOWNSHIP_fieldList = ['GP_LEGL_TW']
    countyObj.RANGE_fieldList = ['GP_RANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['Legal_Descr']
