...
def createCountyObj():
    ...
    countyObj.county_name = 'Hennepin'
    countyObj.cty_fips = r'53'
    countyObj.county_id = r'053'
    countyObj.cty_abbr = r'HENN'
    countyObj.mngeo_web_id = r'Hennepin 053'
    countyObj.sourceZipFile = r'HENN_parcels.zip'
    countyObj.sourcePolygons = r'CADASTRAL_TAX_PROPERTY_BASE.shp'
    ...
    countyObj.BLDG_NUM_fieldList = ['HOUSE_NO']
    ...
    countyObj.STREETNAME_fieldList = ['STREET_NM']
    ...
    countyObj.OWNER_NAME_fieldList = ['OWNER_NM']
    ...
    countyObj.HOMESTEAD_fieldList = ['HMSTD_CD1_']
    countyObj.HOMESTEAD_transferType = ''
    countyObj.TAX_YEAR_fieldList = []
    countyObj.MARKET_YEAR_fieldList = []
    countyObj.EMV_LAND_fieldList = ['EST_LAND_M']
    countyObj.EMV_BLDG_fieldList = ['EST_BLDG_M']
    countyObj.EMV_TOTAL_fieldList = ['MKT_VAL_TO']
    countyObj.TAX_CAPAC_fieldList = []
    countyObj.TOTAL_TAX_fieldList = ['TAX_TOT']
    ...
    countyObj.YEAR_BUILT_fieldList = ['BUILD_YR']
    countyObj.NUM_UNITS_fieldList = []
    countyObj.SALE_DATE_fieldList = ['SALE_DATE']
    countyObj.SALE_DATE_transferType = 'LongIntToDateNoDay'
    countyObj.SALE_VALUE_fieldList = ['SALE_PRICE']
    ...
    countyObj.LEGAL_DESC_fieldList = ['METES_BNDS', 'METES_BN_1'] # TODO: incorporate 'METES_BN_2', 'METES_BN_3', 'MORE_METES'
