...
def createCountyObj():
    ...
    countyObj.county_name = 'Redwood'
    countyObj.cty_fips = r'127'
    countyObj.county_id = r'127'
    countyObj.cty_abbr = r'REDW'
    countyObj.mngeo_web_id = r'Redwood 127'
    countyObj.sourceZipFile = r'REDW_parcels.zip'
    countyObj.sourcePolygons = r'RedwoodCO_Parcels07-015-2016.shp'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['Name']
    ...
    countyObj.ACRES_DEED_fieldList = ['AVDEED']
    ...
    countyObj.OWNER_NAME_fieldList = ['OWNNAM']
    countyObj.OWNER_NAME_transferType = 'defaultTransfer'
    countyObj.OWNER_MORE_fieldList = ['OWNAME']
    ...
    countyObj.OWN_ADD_L4_fieldList = ['OWCITY', 'OWSTAT', 'OWZIPF']
    ...
    countyObj.LEGAL_DESC_fieldList = ['DEDS01', 'DEDS02'] #TODO - ADD MORE LEGAL DESC FIELDS
    ...
    countyObj.ORIG_PIN_fieldList = ['Name']
