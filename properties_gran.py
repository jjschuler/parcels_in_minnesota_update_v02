...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Grant'
        self.cty_fips = r'51'
        self.county_id = r'051'
        self.cty_abbr = r'GRAN'
        self.mngeo_web_id = r'Grant 051'
        self.sourceZipFile = r'GRAN_parcels.zip'
        self.sourcePolygons = r'grant.gdb\parcels'
        ...
        self.STREETNAME_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_PROPERTY_ADDRESS']
        ...
        self.ZIP_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_PROPERTY_ZIP']
        self.ZIP_exists.transferType = ''
        self.ZIP4_exists.fieldTransferList = []
        self.ZIP4_exists.transferType = ''
        self.PLAT_NAME_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_PLAT_NAME']
        self.PLAT_NAME_exists.transferType = ''
        self.BLOCK_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_BLOCK']
        self.BLOCK_exists.transferType = ''
        self.LOT_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_LOT']
        self.LOT_exists.transferType = ''
        self.ACRES_POLY_exists.fieldTransferList = ['CDSTRL_Parcels_GIS_Acres']
        self.ACRES_DEED_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_DEEDED_ACRES']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_NAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = []
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_ADDRESS_1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_ADDRESS_2']
        ...
        self.TAX_NAME_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_NAME']
        self.TAX_NAME_exists.transferType = ''
        self.TAX_ADD_L1_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_ADDRESS']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_ADDRESS_2']
        ...
        self.TAX_YEAR_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAX_YEAR']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_SCHOOL_DISTRICT_NAME']
        ...
        self.SECTION_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_SECTION']
        self.TOWNSHIP_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_TOWNSHIP']
        self.RANGE_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_RANGE']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['GrantCountyTaxData_dbo_tblParcelJoin_LEGAL']
