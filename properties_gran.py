...
def createCountyObj():
    ...
    countyObj.county_name = 'Grant'
    countyObj.cty_fips = r'51'
    countyObj.county_id = r'051'
    countyObj.cty_abbr = r'GRAN'
    countyObj.mngeo_web_id = r'Grant 051'
    countyObj.sourceZipFile = r'GRAN_parcels.zip'
    countyObj.sourcePolygons = r'grant.gdb\parcels'
    ...
    countyObj.STREETNAME_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_PROPERTY_ADDRESS']
    ...
    countyObj.ZIP_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_PROPERTY_ZIP']
    countyObj.ZIP_transferType = 'defaultTransfer'
    countyObj.ZIP4_fieldList = []
    countyObj.ZIP4_transferType = 'defaultTransfer'
    countyObj.PLAT_NAME_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_PLAT_NAME']
    countyObj.PLAT_NAME_transferType = 'defaultTransfer'
    countyObj.BLOCK_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_BLOCK']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_LOT']
    countyObj.LOT_transferType = 'defaultTransfer'
    countyObj.ACRES_POLY_fieldList = ['CDSTRL_Parcels_GIS_Acres']
    countyObj.ACRES_DEED_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_DEEDED_ACRES']
    ...
    countyObj.OWNER_NAME_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_NAME']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_ADDRESS_1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_OWNER_ADDRESS_2']
    ...
    countyObj.TAX_NAME_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_NAME']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_ADDRESS']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAXPAYER_ADDRESS_2']
    ...
    countyObj.TAX_YEAR_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_TAX_YEAR']
    ...
    countyObj.SCHOOL_DST_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_SCHOOL_DISTRICT_NAME']
    ...
    countyObj.SECTION_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_SECTION']
    countyObj.TOWNSHIP_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_TOWNSHIP']
    countyObj.RANGE_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_RANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['GrantCountyTaxData_dbo_tblParcelJoin_LEGAL']
