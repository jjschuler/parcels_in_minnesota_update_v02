...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'St. Louis'
        self.cty_fips = r'137'
        self.county_id = r'137'
        self.cty_abbr = r'STLO'
        self.mngeo_web_id = r'St. Louis 137'
        self.sourceZipFile = r'STLO_parcels.zip'
        self.sourcePolygons = r'SLCCadastral.gdb\CDSTRL_ParcelInfo'
