...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Norman'
        self.cty_fips = r'107'
        self.county_id = r'107'
        self.cty_abbr = r'NORM'
        self.mngeo_web_id = r'Norman 107'
        self.sourceZipFile = r'NORM_parcels.zip'
        self.sourcePolygons = r'norman.gdb\Parcels'
