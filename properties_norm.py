...
def createCountyObj():
    ...
    countyObj.county_name = 'Norman'
    countyObj.cty_fips = r'107'
    countyObj.county_id = r'107'
    countyObj.cty_abbr = r'NORM'
    countyObj.mngeo_web_id = r'Norman 107'
    countyObj.sourceZipFile = r'NORM_parcels.zip'
    countyObj.sourcePolygons = r'norman.gdb\Parcels'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_PARCEL_NUMBER']
    ...
    countyObj.ZIP_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_PROPERTY_ZIP']
    countyObj.ZIP_transferType = 'defaultTransfer'
    countyObj.ZIP4_fieldList = []
    countyObj.ZIP4_transferType = 'defaultTransfer'
    countyObj.PLAT_NAME_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_PLAT_NAME']
    countyObj.PLAT_NAME_transferType = 'defaultTransfer'
    countyObj.BLOCK_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_BLOCK']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_LOT']
    countyObj.LOT_transferType = 'defaultTransfer'
    countyObj.ACRES_POLY_fieldList = []
    countyObj.ACRES_DEED_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_DEEDED_ACRES']
    ...
    countyObj.OWNER_NAME_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_OWNER_NAME']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_OWNER_ADDRESS_1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_OWNER_ADDRESS_2']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_OWNER_ADDRESS_3']
    countyObj.OWN_ADD_L3_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L4_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_OWNER_ADDRESS_4']
    countyObj.OWN_ADD_L4_transferType = 'defaultTransfer'
    countyObj.TAX_NAME_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TAXPAYER_NAME']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TAXPAYER_ADDRESS']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TAXPAYER_ADDRESS_2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TAXPAYER_ADDRESS_3']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TAXPAYER_ADDRESS_4']
    ...
    countyObj.SCHOOL_DST_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_SCHOOL_DISTRICT_NUMBER']
    ...
    countyObj.SECTION_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_SECTION']
    countyObj.TOWNSHIP_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_TOWNSHIP']
    countyObj.RANGE_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_RANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_LEGAL']
    ...
    countyObj.ORIG_PIN_fieldList = ['NormanCountyTax_dbo_tblParcelJoin_PARCEL_NUMBER']
