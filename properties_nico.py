...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Nicollet'
        self.cty_fips = r'103'
        self.county_id = r'103'
        self.cty_abbr = r'NICO'
        self.mngeo_web_id = r'Nicollet 103'
        self.sourceZipFile = r'NICO_parcels.zip'
        self.sourcePolygons = r'Nicollet_Parcels.shp'
