...
def createCountyObj():
    ...
    countyObj.county_name = 'Wilkin'
    countyObj.cty_fips = r'167'
    countyObj.county_id = r'167'
    countyObj.cty_abbr = r'WILK'
    countyObj.mngeo_web_id = r'Wilkin 167'
    countyObj.sourceZipFile = r'WILK_parcels.zip'
    countyObj.sourcePolygons = r'wilkin.gdb\Parcels'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r''
    countyObj.joinInField = r''
    countyObj.joinJoinField = r''
    countyObj.PIN_fieldList = ['Parcels_PARCEL_NUM']
    ...
    countyObj.PLAT_NAME_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXPLATD']
    countyObj.PLAT_NAME_transferType = 'defaultTransfer'
    countyObj.BLOCK_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXBLOK']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXLOT']
    ...
    countyObj.OWNER_NAME_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXONAM']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXOAD1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXOAD2']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXOAD3']
    countyObj.OWN_ADD_L3_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L4_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXOAD4']
    countyObj.OWN_ADD_L4_transferType = 'defaultTransfer'
    countyObj.TAX_NAME_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTNAM']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTAD1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTAD2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTAD3']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTAD4']
    ...
    countyObj.EMV_LAND_fieldList = ['WilkinAS400_dbo_Parcel_Values_Land_Market_Value']
    countyObj.EMV_BLDG_fieldList = ['WilkinAS400_dbo_Parcel_Values_Building_Market_Value']
    countyObj.EMV_TOTAL_fieldList = ['WilkinAS400_dbo_Parcel_Values_Total_Market_Value']
    ...
    countyObj.SECTION_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXSECT']
    countyObj.TOWNSHIP_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXTOWN']
    countyObj.RANGE_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXRANG']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['WilkinAS400_dbo_tblFlatTable_TXDSC1', 'WilkinAS400_dbo_tblFlatTable_TXDSC2'] #TODO - MORE LEGAL DESC TO ADD
    ...
    countyObj.ORIG_PIN_fieldList = ['Parcels_PARCEL_NUM']
