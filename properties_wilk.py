...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Wilkin'
        self.cty_fips = r'167'
        self.county_id = r'167'
        self.cty_abbr = r'WILK'
        self.mngeo_web_id = r'Wilkin 167'
        self.sourceZipFile = r'WILK_parcels.zip'
        self.sourcePolygons = r'wilkin.gdb\Parcels'
