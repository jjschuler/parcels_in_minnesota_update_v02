...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Wadena'
        self.cty_fips = r'159'
        self.county_id = r'159'
        self.cty_abbr = r'WADE'
        self.mngeo_web_id = r'Wadena 159'
        self.sourceZipFile = r'WADE_parcels.zip'
        self.sourcePolygons = r'WadenaCountyParcels.shp'
