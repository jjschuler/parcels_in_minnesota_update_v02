...
def createCountyObj():
    ...
    countyObj.county_name = 'Lake'
    countyObj.cty_fips = r'75'
    countyObj.county_id = r'075'
    countyObj.cty_abbr = r'LAKE'
    countyObj.mngeo_web_id = r'Lake 075'
    countyObj.sourceZipFile = r'LAKE_parcels.zip'
    countyObj.sourcePolygons = r'plan_tax_parcels.gdb\TaxParcels'
    ...
    countyObj.TOWNSHIP_fieldList = ['TWNSHP']
