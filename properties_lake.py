...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        ...
        self.cty_fips = r'75'
        self.county_id = r'075'
        self.cty_abbr = r'LAKE'
        self.mngeo_web_id = r'Lake 075'
        self.sourceZipFile = r'LAKE_parcels.zip'
        self.sourcePolygons = r'plan_tax_parcels.gdb\TaxParcels'
        ...
        self.TOWNSHIP_exists.fieldTransferList = ['TWNSHP']
