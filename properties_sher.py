...
def createCountyObj():
    ...
    countyObj.county_name = 'Sherburne'
    countyObj.cty_fips = r'141'
    countyObj.county_id = r'141'
    countyObj.cty_abbr = r'SHER'
    countyObj.mngeo_web_id = r'Sherburne 141'
    countyObj.sourceZipFile = r'SHER_parcels.zip'
    ...
    countyObj.BLDG_NUM_fieldList = ['HOUSENUM']
    ...
    countyObj.STREETNAME_fieldList = ['STRNAME']
    countyObj.STREETNAME_transferType = ''
    countyObj.STREETTYPE_fieldList = ['STRTYPE']
    countyObj.STREETTYPE_transferType = ''
    countyObj.SUFFIX_DIR_fieldList = ['STRDIR']
    ...
    countyObj.ACRES_POLY_fieldList = ['GIS_ACRES']
    ...
    countyObj.DWELL_TYPE_fieldList = ['CLS_DESC']
    ...
    countyObj.SCHOOL_DST_fieldList = ['SCHL_DIST']
    ...
    countyObj.SECTION_fieldList = ['SEC_NUM']
