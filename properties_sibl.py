...
def createCountyObj():
    ...
    countyObj.county_name = 'Sibley'
    countyObj.cty_fips = r'143'
    countyObj.county_id = r'143'
    countyObj.cty_abbr = r'SIBL'
    countyObj.mngeo_web_id = r'Sibley 143'
    countyObj.sourceZipFile = r'SIBL_parcels.zip'
    ...
    countyObj.PLAT_NAME_fieldList = ['SUBD']
