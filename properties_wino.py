...
def createCountyObj():
    ...
    countyObj.county_name = 'Winona'
    countyObj.cty_fips = r'169'
    countyObj.county_id = r'169'
    countyObj.cty_abbr = r'WINO'
    countyObj.mngeo_web_id = r'Winona 169'
    countyObj.sourceZipFile = r'WINO_parcels.zip'
    countyObj.sourcePolygons = r'Winona_co_parcels.shp'
    ...
    countyObj.OWNER_NAME_fieldList = ['ParcelOwne']
    countyObj.OWNER_NAME_transferType = 'defaultTransfer'
    countyObj.OWNER_MORE_fieldList = ['ParcelAddr']
    ...
    countyObj.TAX_NAME_fieldList = ['PRIM_TAX_1']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['PRIM_TAX_3']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['PRIM_TAX_4']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['PRIM_TAX_5']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['PRIM_TAX_6']
