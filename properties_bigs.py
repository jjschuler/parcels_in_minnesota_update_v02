...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Big Stone'
        self.cty_fips = r'11'
        self.county_id = r'011'
        self.cty_abbr = r'BIGS'
        self.mngeo_web_id = r'Big Stone 011'
        self.sourceZipFile = r'BIGS_parcels.zip'
        self.sourcePolygons = r'Parcel_TaxInfo.shp'
        self.sourceOwnershipZipFile = r''
        self.sourceOwnershipTable = r''
        self.joinInField = r''
        self.joinJoinField = r''
        self.PIN_exists.fieldTransferList = ['PARCEL']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['TXPRNAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = []
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['TXPRADR1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['TXPRADR2']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['TXPRADR3']
        self.OWN_ADD_L3_exists.transferType = ''
        self.OWN_ADD_L4_exists.fieldTransferList = ['TXPRCITY', 'TXPRSTATE', 'TAXZIP5']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['SchoolName']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['PARCEL']
