...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Scott'
        self.cty_fips = r'139'
        self.county_id = r'139'
        self.cty_abbr = r'SCOT'
        self.mngeo_web_id = r'Scott 139'
        self.sourceZipFile = r'SCOT_parcels.zip'
        self.sourcePolygons = r'ScottCounty_Parcels_UTM.shp'
        self.PIN_exists.fieldTransferList = ['PID']
        self.BLDG_NUM_exists.fieldTransferList = ['SHHOUS']
        ...
        self.STREETNAME_exists.fieldTransferList = ['SHSTRE']
        ...
        self.OWN_ADD_L1_exists.fieldTransferList = ['PROPA1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['PROPA2']
        ...
        self.TAX_ADD_L2_exists.fieldTransferList = ['TAXADDR2']
        ...
        self.EMV_LAND_exists.fieldTransferList = ['CYEMVL']
        self.EMV_BLDG_exists.fieldTransferList = ['CYEMVB']
        self.EMV_TOTAL_exists.fieldTransferList = ['CYEMVT']
        ...
        self.SALE_VALUE_exists.fieldTransferList = ['SALPRC']
