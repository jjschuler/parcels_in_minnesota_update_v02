...
def createCountyObj():
    ...
    countyObj.county_name = 'Scott'
    countyObj.cty_fips = r'139'
    countyObj.county_id = r'139'
    countyObj.cty_abbr = r'SCOT'
    countyObj.mngeo_web_id = r'Scott 139'
    countyObj.sourceZipFile = r'SCOT_parcels.zip'
    countyObj.sourcePolygons = r'ScottCounty_Parcels_UTM.shp'
    ...
    countyObj.BLDG_NUM_fieldList = ['SHHOUS']
    ...
    countyObj.STREETNAME_fieldList = ['SHSTRE']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['PROPA1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['PROPA2']
    ...
    countyObj.EMV_LAND_fieldList = ['CYEMVL']
    countyObj.EMV_BLDG_fieldList = ['CYEMVB']
    countyObj.EMV_TOTAL_fieldList = ['CYEMVT']
    ...
    countyObj.SALE_VALUE_fieldList = ['SALPRC']
