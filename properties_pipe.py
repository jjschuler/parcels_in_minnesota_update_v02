...
def createCountyObj():
    ...
    countyObj.county_name = 'Pipestone'
    countyObj.cty_fips = r'117'
    countyObj.county_id = r'117'
    countyObj.cty_abbr = r'PIPE'
    countyObj.mngeo_web_id = r'Pipestone 117'
    countyObj.sourceZipFile = r'PIPE_parcels.zip'
    ...
    countyObj.BLDG_NUM_fieldList = ['HouseNbr']
    ...
    countyObj.STREETNAME_fieldList = ['Address']
    ...
    countyObj.ACRES_POLY_fieldList = ['AcresGIS']
    countyObj.ACRES_DEED_fieldList = ['AcresDeed']
    ...
    countyObj.TAX_NAME_fieldList = ['TaxLName', 'AltTaxName']
    countyObj.TAX_NAME_transferType = 'concatTruncateTwoFields'
    countyObj.TAX_ADD_L1_fieldList = ['TaxAddL1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TaxAddL2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['AltTaxAddL']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['AltTaxAd_1']
    ...
    countyObj.TAX_YEAR_fieldList = ['Year']
