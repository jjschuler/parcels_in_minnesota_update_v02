...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Douglas'
        self.cty_fips = r'41'
        self.county_id = r'041'
        self.cty_abbr = r'DOUG'
        self.mngeo_web_id = r'Douglas 041'
        self.sourceZipFile = r'DOUG_parcels.zip'
        self.sourcePolygons = r'douglas.gdb\parcels'
        ...
        self.PLAT_NAME_exists.fieldTransferList = ['TXPLATD']
        ...
        self.ACRES_POLY_exists.fieldTransferList = ['GIS_ACRES']
        ...
        self.LEGAL_DESC_exists.fieldTransferList = ['TX_DSC_1_8']
