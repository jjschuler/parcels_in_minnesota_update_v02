...
def createCountyObj():
    ...
    countyObj.county_name = 'Douglas'
    countyObj.cty_fips = r'41'
    countyObj.county_id = r'041'
    countyObj.cty_abbr = r'DOUG'
    countyObj.mngeo_web_id = r'Douglas 041'
    countyObj.sourceZipFile = r'DOUG_parcels.zip'
    countyObj.sourcePolygons = r'douglas.gdb\parcels'
    ...
    countyObj.LEGAL_DESC_fieldList = ['TX_DSC_1_8']
