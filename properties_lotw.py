...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Lake of the Woods'
        self.cty_fips = r'77'
        self.county_id = r'077'
        self.cty_abbr = r'LOTW'
        self.mngeo_web_id = r'Lake of the Woods 077'
        self.sourceZipFile = r'LOTW_parcels.zip'
        ...
        self.USE1_DESC_exists.fieldTransferList = ['Classifica']
        self.USE1_DESC_exists.transferType = ''
        self.USE2_DESC_exists.fieldTransferList = ['Classifi_1']
        self.USE2_DESC_exists.transferType = ''
        self.USE3_DESC_exists.fieldTransferList = ['Classifi_2']
        ...
        self.TAX_ADD_L2_exists.fieldTransferList = ['TaxCity', 'TaxState', 'TaxZip']
        self.TAX_ADD_L2_exists.transferType = 'concatTruncateLastAddrLine'
