...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Fillmore'
        self.cty_fips = r'45'
        self.county_id = r'045'
        self.cty_abbr = r'FILL'
        self.mngeo_web_id = r'Fillmore 045'
        self.sourceZipFile = r'FILL_parcels.zip'
        self.sourcePolygons = r'FillmoreParcels.shp'
        ...
        self.ACRES_DEED_exists.fieldTransferList = ['P_DEEDACRE']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['N_NAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = ['N_NAME2']
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['PHYSADDR']
        ...
        self.TAX_ADD_L1_exists.fieldTransferList = ['MailAddr1']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['N_ADDR2']
        self.TAX_ADD_L2_exists.transferType = ''
        self.TAX_ADD_L3_exists.fieldTransferList = ['N_ADDR3']
        self.TAX_ADD_L3_exists.transferType = ''
        self.TAX_ADD_L4_exists.fieldTransferList = ['N_CITY', 'N_STATE', 'N_ZIP', 'N_ZIP_PLUS']
        ...
        self.HOMESTEAD_exists.fieldTransferList = ['H21']
        self.HOMESTEAD_exists.transferType = ''
        self.TAX_YEAR_exists.fieldTransferList = []
        self.MARKET_YEAR_exists.fieldTransferList = []
        self.EMV_LAND_exists.fieldTransferList = ['AREVLA']
        self.EMV_BLDG_exists.fieldTransferList = ['AREVBL']
        self.EMV_TOTAL_exists.fieldTransferList = ['AREAMT']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['DISTRICT']
        ...
        self.SECTION_exists.fieldTransferList = ['GPSECTION']
        self.TOWNSHIP_exists.fieldTransferList = []
        self.RANGE_exists.fieldTransferList = ['GPRANGE']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['L_LEGALDES']
