...
def createCountyObj():
    ...
    countyObj.county_name = 'Fillmore'
    countyObj.cty_fips = r'45'
    countyObj.county_id = r'045'
    countyObj.cty_abbr = r'FILL'
    countyObj.mngeo_web_id = r'Fillmore 045'
    countyObj.sourceZipFile = r'FILL_parcels.zip'
    countyObj.sourcePolygons = r'FillmoreParcels.shp'
    ...
    countyObj.ACRES_DEED_fieldList = ['P_DEEDACRE']
    ...
    countyObj.OWNER_NAME_fieldList = ['N_NAME']
    countyObj.OWNER_NAME_transferType = 'defaultTransfer'
    countyObj.OWNER_MORE_fieldList = ['N_NAME2']
    countyObj.OWNER_MORE_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L1_fieldList = ['PHYSADDR']
    ...
    countyObj.TAX_ADD_L1_fieldList = ['MailAddr1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['N_ADDR2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['N_ADDR3']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['N_CITY', 'N_STATE', 'N_ZIP', 'N_ZIP_PLUS']
    ...
    countyObj.HOMESTEAD_fieldList = ['H21']
    countyObj.HOMESTEAD_transferType = 'defaultTransfer'
    countyObj.TAX_YEAR_fieldList = []
    countyObj.MARKET_YEAR_fieldList = []
    countyObj.EMV_LAND_fieldList = ['AREVLA']
    countyObj.EMV_BLDG_fieldList = ['AREVBL']
    countyObj.EMV_TOTAL_fieldList = ['AREAMT']
    ...
    countyObj.SCHOOL_DST_fieldList = ['DISTRICT']
    ...
    countyObj.SECTION_fieldList = ['GPSECTION']
    countyObj.TOWNSHIP_fieldList = []
    countyObj.RANGE_fieldList = ['GPRANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['L_LEGALDES']
