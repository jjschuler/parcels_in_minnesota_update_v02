...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Itasca'
        self.cty_fips = r'61'
        self.county_id = r'061'
        self.cty_abbr = r'ITAS'
        self.mngeo_web_id = r'Itasca 061'
        self.sourceZipFile = r'ITAS_parcels.zip'
        self.sourcePolygons = r'Itasca_Parcels.shp'
        self.sourceOwnershipZipFile = r''
        self.sourceOwnershipTable = r''
        self.joinInField = r''
        self.joinJoinField = r''
        self.PIN_exists.fieldTransferList = ['PARENTPIN']
        ...
        self.TAX_NAME_exists.fieldTransferList = ['TAO_NAME']
        self.TAX_NAME_exists.transferType = ''
        self.TAX_ADD_L1_exists.fieldTransferList = ['ADDR_1']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['ADDR_2']
        self.TAX_ADD_L2_exists.transferType = ''
        self.TAX_ADD_L3_exists.fieldTransferList = ['ADDR_3']
        self.TAX_ADD_L3_exists.transferType = ''
        self.TAX_ADD_L4_exists.fieldTransferList = ['ADDR_4']
        ...
        self.EMV_LAND_exists.fieldTransferList = ['LAND_EST']
        ...
        self.LEGAL_DESC_exists.fieldTransferList = ['DESCRIP']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['PARENTPIN']
