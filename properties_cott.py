...
def createCountyObj():
    ...
    countyObj.sourceZipFile = r'COTT.zip'
    countyObj.sourcePolygons = r'Cottonwood MN.gdb\Basemap\Parcels'
    ...
    countyObj.ZIP_fieldList = ['propzip1']
    ...
    countyObj.OWNER_MORE_fieldList = ['contrhold']
    ...
    countyObj.OWN_ADD_L4_fieldList = ['deedaddr4']
    ...
    countyObj.SCHOOL_DST_fieldList = ['TXSCHL']
