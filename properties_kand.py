...
def createCountyObj():
    ...
    countyObj.county_name = 'Kandiyohi'
    countyObj.cty_fips = r'67'
    countyObj.county_id = r'067'
    countyObj.cty_abbr = r'KAND'
    countyObj.mngeo_web_id = r'Kandiyohi 067'
    countyObj.sourceZipFile = r'KAND_parcels.zip'
    ...
    countyObj.BLDG_NUM_fieldList = ['PROPHSENUM']
    countyObj.BLDG_NUM_transferType = 'defaultTransfer'
    countyObj.PREFIX_DIR_fieldList = ['PROPDIR']
    ...
    countyObj.STREETNAME_fieldList = ['PROPROAD']
    ...
    countyObj.ZIP_fieldList = ['PROPZIP']
    ...
    countyObj.BLOCK_fieldList = ['BLOCKNO']
    countyObj.BLOCK_transferType = 'defaultTransfer'
    countyObj.LOT_fieldList = ['LOTNO']
    countyObj.LOT_transferType = 'defaultTransfer'
    countyObj.ACRES_POLY_fieldList = ['GISAcres']
    ...
    countyObj.OWNER_MORE_fieldList = ['OWNNAME2']
    countyObj.OWNER_MORE_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L1_fieldList = ['OWNADDRESS']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['OWNADD2']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['OWNCITY', 'OWNSTATE', 'OWNZIP']
    ...
    countyObj.TAX_NAME_fieldList = ['TAXNAME', 'TAXNAME2']
    countyObj.TAX_NAME_transferType = 'concatTruncateTwoFields'
    countyObj.TAX_ADD_L1_fieldList = ['TAXADDRESS']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TAXADD2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['TAXCITY', 'TAXSTATE', 'TAXZIP']
    ...
    countyObj.SECTION_fieldList = ['SECT']
    countyObj.TOWNSHIP_fieldList = ['TWP']
    countyObj.RANGE_fieldList = ['RNG']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['DESC_', 'DESC1']
