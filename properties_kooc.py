...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Koochiching'
        self.cty_fips = r'71'
        self.county_id = r'071'
        self.cty_abbr = r'KOOC'
        self.mngeo_web_id = r'Koochiching 071'
        self.sourceZipFile = r'KOOC_parcels.zip'
        self.sourcePolygons = r'koochiching.gdb\Parcels'
        self.sourceOwnershipZipFile = r''
        self.sourceOwnershipTable = r''
        self.joinInField = r''
        self.joinJoinField = r''
        self.PIN_exists.fieldTransferList = ['PARCEL_ID']
        ...
        self.ZIP_exists.fieldTransferList = ['ZipCode5']
        ...
        self.OWN_ADD_L4_exists.fieldTransferList = ['OWNZIP5']
        ...
        self.TOTAL_TAX_exists.fieldTransferList = ['NETTAX']
        ...
        self.SALE_VALUE_exists.fieldTransferList = ['PUR_PRICE']
        self.SCHOOL_DST_exists.fieldTransferList = ['SCHLDIST']
        ...
        self.TOWNSHIP_exists.fieldTransferList = ['TOWN']
        self.RANGE_exists.fieldTransferList = ['RANG']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['PARCEL_ID']
