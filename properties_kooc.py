...
def createCountyObj():
    ...
    countyObj.county_name = 'Koochiching'
    countyObj.cty_fips = r'71'
    countyObj.county_id = r'071'
    countyObj.cty_abbr = r'KOOC'
    countyObj.mngeo_web_id = r'Koochiching 071'
    countyObj.sourceZipFile = r'KOOC_parcels.zip'
    countyObj.sourcePolygons = r'koochiching.gdb\Parcels'
    ...
    countyObj.ZIP_fieldList = ['ZipCode5']
    ...
    countyObj.OWN_ADD_L4_fieldList = ['OWNZIP5']
    ...
    countyObj.TOTAL_TAX_fieldList = ['NETTAX']
    ...
    countyObj.SALE_VALUE_fieldList = ['PUR_PRICE']
    countyObj.SCHOOL_DST_fieldList = ['SCHLDIST']
    ...
    countyObj.TOWNSHIP_fieldList = ['TOWN']
    countyObj.RANGE_fieldList = ['RANG']
