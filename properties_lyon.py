...
def createCountyObj():
    ...
    countyObj.county_name = 'Lyon'
    countyObj.cty_fips = r'83'
    countyObj.county_id = r'083'
    countyObj.cty_abbr = r'LYON'
    countyObj.mngeo_web_id = r'Lyon 083'
    countyObj.sourceZipFile = r'LYON_parcels.zip'
    ...
    countyObj.OWNER_NAME_fieldList = ['TXONAM']
    ...
    countyObj.HOMESTEAD_fieldList = ['Hstddesc']
    ...
    countyObj.EMV_TOTAL_fieldList = ['TXEVAL']
    ...
    countyObj.SECTION_fieldList = ['TXSECT']
    countyObj.TOWNSHIP_fieldList = ['TXTOWN']
    countyObj.RANGE_fieldList = ['TXRANG']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['LegalD']
