...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Goodhue'
        self.cty_fips = r'49'
        self.county_id = r'049'
        self.cty_abbr = r'GOOD'
        self.mngeo_web_id = r'Goodhue 049'
        self.sourceZipFile = r'GOOD_parcels.zip'
        self.sourcePolygons = r'GoodhueCoParcels04252016.shp'
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['C0SORTNMP']
