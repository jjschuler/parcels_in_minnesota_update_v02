...
def createCountyObj():
    ...
    countyObj.county_name = 'Goodhue'
    countyObj.cty_fips = r'49'
    countyObj.county_id = r'049'
    countyObj.cty_abbr = r'GOOD'
    countyObj.mngeo_web_id = r'Goodhue 049'
    countyObj.sourceZipFile = r'GOOD_parcels.zip'
    countyObj.sourcePolygons = r'GoodhueCoParcels04252016.shp'
    ...
    countyObj.OWNER_NAME_fieldList = ['C0SORTNMP']
