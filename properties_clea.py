...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Clearwater'
        self.cty_fips = r'29'
        self.county_id = r'029'
        self.cty_abbr = r'CLEA'
        self.mngeo_web_id = r'Clearwater 029'
        self.sourceZipFile = r'CLEA_parcels.zip'
        self.sourcePolygons = r'County_Parcel.shp'
        ...
        self.USE1_DESC_exists.fieldTransferList = ['HomesteadC']
        self.USE1_DESC_exists.transferType = ''
        self.USE2_DESC_exists.fieldTransferList = ['Homestea_1']
        self.USE2_DESC_exists.transferType = ''
        self.USE3_DESC_exists.fieldTransferList = ['Homestea_2']
        self.USE3_DESC_exists.transferType = ''
        self.USE4_DESC_exists.fieldTransferList = ['Homestea_3', 'Homestea_4']
        self.USE4_DESC_exists.transferType = 'concatTruncateTwoFields'
        ...
        self.OWN_ADD_L1_exists.fieldTransferList = ['PropAdd']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['PropCity']
        ...
        self.TAX_ADD_L1_exists.fieldTransferList = ['TaxAddr']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['TaxCity', 'TaxZip']
        ...
        self.MARKET_YEAR_exists.fieldTransferList = ['Assessment']
        self.EMV_LAND_exists.fieldTransferList = ['EMVLand']
        self.EMV_BLDG_exists.fieldTransferList = ['EMVBldg']
        self.EMV_TOTAL_exists.fieldTransferList = ['EMVTotal']
        self.TAX_CAPAC_exists.fieldTransferList = []
        self.TOTAL_TAX_exists.fieldTransferList = ['TotalTax']
        self.SPEC_ASSES_exists.fieldTransferList = ['SpecialAss']
        ...
        self.SECTION_exists.fieldTransferList = ['Section']
