...
def createCountyObj():
    ...
    countyObj.county_name = 'Blue Earth'
    countyObj.cty_fips = r'13'
    countyObj.county_id = r'013'
    countyObj.cty_abbr = r'BLUE'
    countyObj.mngeo_web_id = r'Blue Earth 013'
    countyObj.sourceZipFile = r'BLUE_parcels.zip'
    countyObj.sourcePolygons = r'Parcel_BEC.shp'
    ...
    countyObj.OWNER_NAME_fieldList = ['DEEDHOLD_1']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = ['DEEDHOLD_2']
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['MAILTO_ADD']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['MAILTO_A_1']
    countyObj.OWN_ADD_L2_transferType = ''
    countyObj.OWN_ADD_L3_fieldList = ['MAILTO_CIT', 'MAILTO_STA', 'MAILTO_ZIP']
