...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Blue Earth'
        self.cty_fips = r'13'
        self.county_id = r'013'
        self.cty_abbr = r'BLUE'
        self.mngeo_web_id = r'Blue Earth 013'
        self.sourceZipFile = r'BLUE_parcels.zip'
        self.sourcePolygons = r'Parcel_BEC.shp'
        ...
        self.STREETNAME_exists.fieldTransferList = ['ADDRESS']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['DEEDHOLD_1']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = ['DEEDHOLD_2']
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['MAILTO_ADD']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['MAILTO_A_1']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['MAILTO_CIT', 'MAILTO_STA', 'MAILTO_ZIP']
