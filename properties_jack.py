...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        ...
        self.cty_fips = r'63'
        self.county_id = r'063'
        self.cty_abbr = r'JACK'
        self.mngeo_web_id = r'Jackson 063'
        self.sourceZipFile = r'JACK_parcels.zip'
        self.sourcePolygons = r'JCParcels071316.shp'
        ...
        self.ACRES_DEED_exists.fieldTransferList = ['V1DEEDACRE']
        ...
        self.OWNER_MORE_exists.fieldTransferList = ['V1OW2NAME']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['V1SCHOOL']
        ...
        self.SECTION_exists.fieldTransferList = ['V1LGLSEC_1']
        self.TOWNSHIP_exists.fieldTransferList = ['V1LGLTWP_1']
        self.RANGE_exists.fieldTransferList = ['V1LGLRNG_1']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['V1LGLDSC1', 'V1LGLDSC2']
