...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Carlton'
        self.cty_fips = r'17'
        self.county_id = r'017'
        self.cty_abbr = r'CARL'
        self.mngeo_web_id = r'Carlton 017'
        self.sourceZipFile = r'CARL_parcels.zip'
        ...
        self.BLDG_NUM_exists.fieldTransferList = ['PHYSADDR']
        ...
        self.STREETNAME_exists.fieldTransferList = ['PHYSADDR']
        ...
        self.BLOCK_exists.fieldTransferList = ['APBLOK']
        self.BLOCK_exists.transferType = ''
        self.LOT_exists.fieldTransferList = ['APLOT']
        ...
        self.TOTAL_TAX_exists.fieldTransferList = ['TPNTAX']
