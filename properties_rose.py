...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Roseau'
        self.cty_fips = r'135'
        self.county_id = r'135'
        self.cty_abbr = r'ROSE'
        self.mngeo_web_id = r'Roseau 135'
        self.sourceZipFile = r'ROSE_parcels.zip'
        self.sourcePolygons = r'roseau.gdb\Parcels'
