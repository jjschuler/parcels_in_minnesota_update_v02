...
def createCountyObj():
    ...
    countyObj.county_name = 'Roseau'
    countyObj.cty_fips = r'135'
    countyObj.county_id = r'135'
    countyObj.cty_abbr = r'ROSE'
    countyObj.mngeo_web_id = r'Roseau 135'
    countyObj.sourceZipFile = r'ROSE_parcels.zip'
    countyObj.sourcePolygons = r'roseau.gdb\Parcels'
