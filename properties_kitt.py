...
def createCountyObj():
    ...
    countyObj.county_name = 'Kittson'
    countyObj.cty_fips = r'69'
    countyObj.county_id = r'069'
    countyObj.cty_abbr = r'KITT'
    countyObj.mngeo_web_id = r'Kittson 069'
    countyObj.sourceZipFile = r'KITT_parcels.zip'
    ...
    countyObj.OWN_ADD_L1_fieldList = ['PROPERTY_A']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['PROPERTY_1']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['PROPERTY_2']
    countyObj.OWN_ADD_L3_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L4_fieldList = ['PROPERTY_C', 'PROPERTY_S', 'PROPERTY_Z']
