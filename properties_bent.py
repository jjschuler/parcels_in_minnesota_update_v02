...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Benton'
        self.cty_fips = r'9'
        self.county_id = r'009'
        self.cty_abbr = r'BENT'
        self.mngeo_web_id = r'Benton 009'
        self.sourceZipFile = r'BENT_parcels.zip'
        self.sourcePolygons = r'Parcels\Parcels.shp'
        self.sourceOwnershipZipFile = r''
        self.sourceOwnershipTable = r''
        self.joinInField = r''
        self.joinJoinField = r''
        self.PIN_exists.fieldTransferList = ['TaxPIN']
        self.BLDG_NUM_exists.fieldTransferList = ['ADDRS_1']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['OWNER_1']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = ['OWNER_2']
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['MAIL_1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['MAIL_2']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['MAIL_3']
        self.OWN_ADD_L3_exists.transferType = ''
        self.OWN_ADD_L4_exists.fieldTransferList = ['MAIL_4']
        ...
        self.TAX_EXEMPT_exists.fieldTransferList = ['ExemptStat']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['SCHDIST']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['TaxPIN']
