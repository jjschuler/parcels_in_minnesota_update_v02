...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Mower'
        self.cty_fips = r'99'
        self.county_id = r'099'
        self.cty_abbr = r'MOWE'
        self.mngeo_web_id = r'Mower 099'
        self.sourceZipFile = r'MOWE_parcels.zip'
        self.sourcePolygons = r'Parcel_GIS.shp'
