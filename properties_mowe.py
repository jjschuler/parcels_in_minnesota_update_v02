...
def createCountyObj():
    ...
    countyObj.county_name = 'Mower'
    countyObj.cty_fips = r'99'
    countyObj.county_id = r'099'
    countyObj.cty_abbr = r'MOWE'
    countyObj.mngeo_web_id = r'Mower 099'
    countyObj.sourceZipFile = r'MOWE_parcels.zip'
    countyObj.sourcePolygons = r'01162015\20150113_Parcels.shp'
    ...
    countyObj.BLDG_NUM_fieldList = ['SAStreetNu']
    countyObj.BLDG_NUM_transferType = 'defaultTransfer'
    countyObj.PREFIX_DIR_fieldList = ['SAPredirec']
    ...
    countyObj.OWNER_NAME_fieldList = ['CurOwnerNa']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['CurOwnerAd']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['CurOwnerCi', 'CurOwnerSt', 'CurOwnerPo']
    ...
    countyObj.LEGAL_DESC_fieldList = ['AbbrDescr', 'AbbrDescr2']
