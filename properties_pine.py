...
def createCountyObj():
    ...
    countyObj.county_name = 'Pine'
    countyObj.cty_fips = r'115'
    countyObj.county_id = r'115'
    countyObj.cty_abbr = r'PINE'
    countyObj.mngeo_web_id = r'Pine 115'
    countyObj.sourceZipFile = r'PINE_parcels.zip'
    countyObj.sourcePolygons = r'PINE COUNTY.PARCELS\ENTIRE_COUNTY_PARCELS.shp'
