...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Marshall'
        self.cty_fips = r'89'
        self.county_id = r'089'
        self.cty_abbr = r'MARS'
        self.mngeo_web_id = r'Marshall 089'
        self.sourceZipFile = r'MARS_parcels.zip'
        self.sourcePolygons = r'MarshallCoParcels.shp'
