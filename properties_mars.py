...
def createCountyObj():
    ...
    countyObj.county_name = 'Marshall'
    countyObj.cty_fips = r'89'
    countyObj.county_id = r'089'
    countyObj.cty_abbr = r'MARS'
    countyObj.mngeo_web_id = r'Marshall 089'
    countyObj.sourceZipFile = r'MARS_parcels.zip'
    countyObj.sourcePolygons = r'MarshallCoParcels.shp'
