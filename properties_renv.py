...
def createCountyObj():
    ...
    countyObj.county_name = 'Renville'
    countyObj.cty_fips = r'129'
    countyObj.county_id = r'129'
    countyObj.cty_abbr = r'RENV'
    countyObj.mngeo_web_id = r'Renville 129'
    countyObj.sourceZipFile = r'RENV_parcels.zip'
    ...
    countyObj.BLDG_NUM_fieldList = ['APHOUS']
    ...
    countyObj.STREETNAME_fieldList = ['APSNAM']
    ...
    countyObj.ACRES_DEED_fieldList = ['TPDEED']
    ...
    countyObj.OWN_ADD_L4_fieldList = ['OWCITY', 'OWSTATE', 'OWZIP5']
    countyObj.OWN_ADD_L4_transferType = 'concatTruncateLastAddrLine'
    countyObj.TAX_NAME_fieldList = ['TXPRNAME']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['TXPRADR1']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TXPRADR2']
    countyObj.TAX_ADD_L2_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L3_fieldList = ['TXPRADR3']
    countyObj.TAX_ADD_L3_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L4_fieldList = ['TXPRCITY', 'TXPRSTATE', 'TAXZIP5']
    ...
    countyObj.SCHOOL_DST_fieldList = ['APSCHL']
