...
def createCountyObj():
    ...
    countyObj.county_name = 'Mille Lacs'
    countyObj.cty_fips = r'95'
    countyObj.county_id = r'095'
    countyObj.cty_abbr = r'MILL'
    countyObj.mngeo_web_id = r'Mille Lacs 095'
    countyObj.sourceZipFile = r'MILL_parcels.zip'
    countyObj.sourcePolygons = r'Mille Lacs County-Parcels\MLC-Parcels.shp'
    ...
    countyObj.OWN_ADD_L4_fieldList = ['OWNER_AD_3']
    ...
    countyObj.TAX_ADD_L4_fieldList = ['TAXPAYER_3']
