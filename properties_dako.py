...
def createCountyObj():
    ...
    countyObj.county_name = 'Dakota'
    countyObj.cty_fips = r'37'
    countyObj.county_id = r'037'
    countyObj.cty_abbr = r'DAKO'
    countyObj.mngeo_web_id = r'Dakota 037'
    countyObj.sourceZipFile = r'DAKO_parcels.zip'
    countyObj.sourcePolygons = r'parcels_metrogis.gdb\parcela_metrogis'
