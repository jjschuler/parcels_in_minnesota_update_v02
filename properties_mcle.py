...
def createCountyObj():
    ...
    countyObj.county_name = 'McLeod'
    countyObj.cty_fips = r'85'
    countyObj.county_id = r'085'
    countyObj.cty_abbr = r'MCLE'
    countyObj.mngeo_web_id = r'McLeod 085'
    countyObj.sourceZipFile = r'MCLE_parcels.zip'
    countyObj.sourcePolygons = r'McLeod\Parcels.shp'
    ...
    countyObj.BLDG_NUM_fieldList = ['HOUSE_NUMB']
    ...
    countyObj.USE1_DESC_fieldList = ['CLSSDESC']
    ...
    countyObj.TAX_NAME_fieldList = ['TAXPAYER1', 'TAXPAYER2']
