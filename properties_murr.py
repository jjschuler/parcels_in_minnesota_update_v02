...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Murray'
        self.cty_fips = r'101'
        self.county_id = r'101'
        self.cty_abbr = r'MURR'
        self.mngeo_web_id = r'Murray 101'
        self.sourceZipFile = r'MURR_parcels.zip'
        self.sourcePolygons = r'MurrayCountyParcels.shp'
