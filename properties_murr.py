...
def createCountyObj():
    ...
    countyObj.county_name = 'Murray'
    countyObj.cty_fips = r'101'
    countyObj.county_id = r'101'
    countyObj.cty_abbr = r'MURR'
    countyObj.mngeo_web_id = r'Murray 101'
    countyObj.sourceZipFile = r'MURR_parcels.zip'
    countyObj.sourcePolygons = r'MurrayCountyParcels.shp'
    ...
    countyObj.STREETNAME_fieldList = ['Street']
    ...
    countyObj.ACRES_POLY_fieldList = ['CompAcres']
    ...
    countyObj.OWNER_NAME_fieldList = ['FIRSTLAST']
