...
def createCountyObj():
    ...
    countyObj.county_name = 'Isanti'
    countyObj.cty_fips = r'59'
    countyObj.county_id = r'059'
    countyObj.cty_abbr = r'ISAN'
    countyObj.mngeo_web_id = r'Isanti 059'
    countyObj.sourceZipFile = r'ISAN_parcels.zip'
    countyObj.sourcePolygons = r'08222016.shp'
    ...
    countyObj.UNIT_INFO_fieldList = ['UnitNumber']
    ...
    countyObj.USE2_DESC_fieldList = ['PriClass']
    countyObj.USE2_DESC_transferType = 'defaultTransfer'
    countyObj.USE3_DESC_fieldList = ['SecClass']
    countyObj.USE3_DESC_transferType = 'defaultTransfer'
    countyObj.USE4_DESC_fieldList = ['ThirdClass']
    ...
    countyObj.TAX_NAME_fieldList = ['PrimaryTax']
    countyObj.TAX_NAME_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L1_fieldList = ['TaxPayerAd']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['TaxPayerCS']
    ...
    countyObj.EMV_TOTAL_fieldList = ['TotalEMV']
    ...
    countyObj.RANGE_fieldList = ['Range_']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['LegalMetes']
