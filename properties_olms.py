...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Olmsted'
        self.cty_fips = r'109'
        self.county_id = r'109'
        self.cty_abbr = r'OLMS'
        self.mngeo_web_id = r'Olmsted 109'
        self.sourceZipFile = r'OLMS_parcels.zip'
        self.sourcePolygons = r'Parcels\Parcels\Parcels.shp'
