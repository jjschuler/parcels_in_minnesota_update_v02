...
def createCountyObj():
    ...
    countyObj.county_name = 'Cass'
    countyObj.cty_fips = r'21'
    countyObj.county_id = r'021'
    countyObj.cty_abbr = r'CASS'
    countyObj.mngeo_web_id = r'Cass 021'
    countyObj.sourceZipFile = r'CASS_parcels.zip'
    countyObj.sourcePolygons = r'CassCo_Ownership.shp'
