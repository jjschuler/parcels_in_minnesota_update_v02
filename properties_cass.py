...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Cass'
        self.cty_fips = r'21'
        self.county_id = r'021'
        self.cty_abbr = r'CASS'
        self.mngeo_web_id = r'Cass 021'
        self.sourceZipFile = r'CASS_parcels.zip'
        self.sourcePolygons = r'CassCo_Ownership.shp'
