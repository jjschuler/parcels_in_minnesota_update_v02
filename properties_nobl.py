...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Nobles'
        self.cty_fips = r'105'
        self.county_id = r'105'
        self.cty_abbr = r'NOBL'
        self.mngeo_web_id = r'Nobles 105'
        self.sourceZipFile = r'NOBL_parcels.zip'
        self.sourcePolygons = r'NOBL_parcels.shp'
