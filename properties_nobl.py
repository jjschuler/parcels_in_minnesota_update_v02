...
def createCountyObj():
    ...
    countyObj.county_name = 'Nobles'
    countyObj.cty_fips = r'105'
    countyObj.county_id = r'105'
    countyObj.cty_abbr = r'NOBL'
    countyObj.mngeo_web_id = r'Nobles 105'
    countyObj.sourceZipFile = r'NOBL_parcels.zip'
    countyObj.sourcePolygons = r'NOBL_parcels.shp'
    ...
    countyObj.PLAT_NAME_fieldList = ['PlatDescr']
    ...
    countyObj.USE1_DESC_fieldList = ['PropClass']
    ...
    countyObj.OWNER_MORE_fieldList = ['AlternateN']
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['PropAddr1']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['PropZip1']
    ...
    countyObj.TAX_ADD_L1_fieldList = ['TaxAddr1']
    countyObj.TAX_ADD_L1_transferType = ''
    countyObj.TAX_ADD_L2_fieldList = ['TaxAddr2']
    countyObj.TAX_ADD_L2_transferType = ''
    countyObj.TAX_ADD_L3_fieldList = ['TaxAddr3']
    countyObj.TAX_ADD_L3_transferType = ''
    countyObj.TAX_ADD_L4_fieldList = ['TaxAddr4']
    ...
    countyObj.LEGAL_DESC_fieldList = ['TaxDescr']
