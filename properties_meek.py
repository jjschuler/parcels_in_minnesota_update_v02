...
def createCountyObj():
    ...
    countyObj.county_name = 'Meeker'
    countyObj.cty_fips = r'93'
    countyObj.county_id = r'093'
    countyObj.cty_abbr = r'MEEK'
    countyObj.mngeo_web_id = r'Meeker 093'
    countyObj.sourceZipFile = r'MEEK_parcels.zip'
