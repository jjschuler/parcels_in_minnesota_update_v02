...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Houston'
        self.cty_fips = r'55'
        self.county_id = r'055'
        self.cty_abbr = r'HOUS'
        self.mngeo_web_id = r'Houston 055'
        self.sourceZipFile = r'HOUS_parcels.zip'
        self.sourcePolygons = r'HoustonCoParcels5_2015.shp'
        ...
        self.CITY_exists.fieldTransferList = ['GP_CITY']
        ...
        self.BLOCK_exists.fieldTransferList = ['GP_BLOCK']
        self.BLOCK_exists.transferType = ''
        self.LOT_exists.fieldTransferList = ['GP_LOT']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['OWNER']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = ['OWNER2']
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['OWNERADDR']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['OWNERCITY', 'OWNERZIP']
        self.OWN_ADD_L2_exists.transferType = 'concatTruncateTwoFields'
        ...
        self.EMV_LAND_exists.fieldTransferList = ['LandVal']
        self.EMV_BLDG_exists.fieldTransferList = ['BldgVal']
        ...
        self.WSHD_DIST_exists.fieldTransferList = ['WatershedD']
        ...
        self.SECTION_exists.fieldTransferList = ['PLS_SECT']
        self.TOWNSHIP_exists.fieldTransferList = ['GP_LEGL_TW']
        self.RANGE_exists.fieldTransferList = ['GP_RANGE']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['LEGAL1', 'LEGAL2']
