...
def createCountyObj():
    ...
    countyObj.county_name = 'Houston'
    countyObj.cty_fips = r'55'
    countyObj.county_id = r'055'
    countyObj.cty_abbr = r'HOUS'
    countyObj.mngeo_web_id = r'Houston 055'
    countyObj.sourceZipFile = r'HOUS_parcels.zip'
    countyObj.sourcePolygons = r'HoustonCoParcels5_2015.shp'
    ...
    countyObj.CITY_fieldList = ['GP_CITY']
    ...
    countyObj.OWNER_NAME_fieldList = ['OWNER']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = ['OWNER2']
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['OWNERADDR']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['OWNERCITY', 'OWNERZIP']
    ...
    countyObj.EMV_LAND_fieldList = ['LandVal']
    countyObj.EMV_BLDG_fieldList = ['BldgVal']
    ...
    countyObj.WSHD_DIST_fieldList = ['WatershedD']
    ...
    countyObj.SECTION_fieldList = ['PLS_SECT']
