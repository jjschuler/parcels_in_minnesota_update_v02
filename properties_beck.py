...
def createCountyObj():
    ...
    countyObj.county_name = 'Becker'
    countyObj.cty_fips = r'5'
    countyObj.county_id = r'005'
    countyObj.cty_abbr = r'BECK'
    countyObj.mngeo_web_id = r'Becker 005'
    countyObj.sourceZipFile = r'BECK_parcels.zip'
    ...
    countyObj.SALE_DATE_transferType = 'defaultTransfer'
