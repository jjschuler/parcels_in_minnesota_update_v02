...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Becker'
        self.cty_fips = r'5'
        self.county_id = r'005'
        self.cty_abbr = r'BECK'
        self.mngeo_web_id = r'Becker 005'
        self.sourceZipFile = r'BECK_parcels.zip'
        ...
        self.SALE_DATE_exists.transferType = ''
