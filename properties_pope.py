...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Pope'
        self.cty_fips = r'121'
        self.county_id = r'121'
        self.cty_abbr = r'POPE'
        self.mngeo_web_id = r'Pope 121'
        self.sourceZipFile = r'POPE_parcels.zip'
        self.sourcePolygons = r'Parcels_TaxData.shp'
