...
def createCountyObj():
    ...
    countyObj.county_name = 'Pope'
    countyObj.cty_fips = r'121'
    countyObj.county_id = r'121'
    countyObj.cty_abbr = r'POPE'
    countyObj.mngeo_web_id = r'Pope 121'
    countyObj.sourceZipFile = r'POPE_parcels.zip'
    countyObj.sourcePolygons = r'Parcels_TaxData.shp'
