...
def createCountyObj():
    ...
    countyObj.county_name = 'Martin'
    countyObj.cty_fips = r'91'
    countyObj.county_id = r'091'
    countyObj.cty_abbr = r'MART'
    countyObj.mngeo_web_id = r'Martin 091'
    countyObj.sourceZipFile = r'MART_parcels.zip'
    countyObj.sourcePolygons = r'ECN_MartinCo_Parcels.shp'
    ...
    countyObj.ACRES_POLY_fieldList = ['Graphic_Ac']
    countyObj.ACRES_DEED_fieldList = ['Acres']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['DeedAddr1']
    countyObj.OWN_ADD_L1_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L2_fieldList = ['DeedAddr2']
    countyObj.OWN_ADD_L2_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L3_fieldList = ['DeedAddr3']
    countyObj.OWN_ADD_L3_transferType = 'defaultTransfer'
    countyObj.OWN_ADD_L4_fieldList = ['DeedCity','DeedState', 'DeedZip']
    ...
    countyObj.EMV_TOTAL_fieldList = ['Total_LV']
    ...
    countyObj.SALE_DATE_fieldList = []   #TODO - figure out transfer modification for field 'SaleDate' - would not transfer
    countyObj.SALE_DATE_transferType = 'ToDate'
    countyObj.SALE_VALUE_fieldList = ['AdjSaleAmt']
    ...
    countyObj.LEGAL_DESC_fieldList = ['Legal1']
