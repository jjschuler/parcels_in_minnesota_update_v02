...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        ...
        self.cty_fips = r'91'
        self.county_id = r'091'
        self.cty_abbr = r'MART'
        self.mngeo_web_id = r'Martin 091'
        self.sourceZipFile = r'MART_parcels.zip'
        self.sourcePolygons = r'ECN_MartinCo_Parcels.shp'
