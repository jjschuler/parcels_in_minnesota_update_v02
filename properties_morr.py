...
def createCountyObj():
    ...
    countyObj.county_name = 'Morrison'
    countyObj.cty_fips = r'97'
    countyObj.county_id = r'097'
    countyObj.cty_abbr = r'MORR'
    countyObj.mngeo_web_id = r'Morrison 097'
    countyObj.sourceZipFile = r'MORR_parcels.zip'
    countyObj.sourcePolygons = r'Parcels_20160718.shp'
    ...
    countyObj.BLDG_NUM_fieldList = ['SitusStNo']
