...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Morrison'
        self.cty_fips = r'97'
        self.county_id = r'097'
        self.cty_abbr = r'MORR'
        self.mngeo_web_id = r'Morrison 097'
        self.sourceZipFile = r'MORR_parcels.zip'
        self.sourcePolygons = r'Parcels_20160718.shp'
