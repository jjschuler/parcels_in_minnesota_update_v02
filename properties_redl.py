...
def createCountyObj():
    ...
    countyObj.county_name = 'Red Lake'
    countyObj.cty_fips = r'125'
    countyObj.county_id = r'125'
    countyObj.cty_abbr = r'REDL'
    countyObj.mngeo_web_id = r'Red Lake 125'
    countyObj.sourceZipFile = r'REDL_parcels.zip.lnk'
