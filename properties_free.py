...
def createCountyObj():
    ...
    countyObj.county_name = 'Freeborn'
    countyObj.cty_fips = r'47'
    countyObj.county_id = r'047'
    countyObj.cty_abbr = r'FREE'
    countyObj.mngeo_web_id = r'Freeborn 047'
    countyObj.sourceZipFile = r'FREE_parcels.zip'
    countyObj.sourcePolygons = r'FreebornCounty_Parcels.shp'
    ...
    countyObj.ACRES_POLY_fieldList = ['CALCACRES']
