...
def createCountyObj():
    ...
    countyObj.county_name = 'Aitkin'
    countyObj.cty_fips = r'1'
    countyObj.county_id = r'001'
    countyObj.cty_abbr = r'AITK'
    countyObj.mngeo_web_id = r'Aitkin 001'
    countyObj.sourceZipFile = r'AITK.zip'
    countyObj.sourcePolygons = r'Aitk_GSC_Data.gdb\TAX_PARCELS'
    countyObj.sourceOwnershipZipFile = r''
    countyObj.sourceOwnershipTable = r'Aitk_GSC_Data.gdb\TAXDATA'
    countyObj.joinInField = r'PRINT_KEY'
    countyObj.joinJoinField = r'PRCL_NBR'
    countyObj.PIN_fieldList = ['TAX_PARCELS_PRINT_KEY']
    ...
    countyObj.CITY_fieldList = ['TAXDATA_Physical_City']
    ...
    countyObj.PLAT_NAME_fieldList = ['TAXDATA_PLAT_DESC']
    ...
    countyObj.ACRES_DEED_fieldList = ['TAXDATA_DEEDED_ACRES']
    countyObj.USE1_DESC_fieldList = ['TAXDATA_TPCLS1']
    countyObj.USE1_DESC_transferType = ''
    countyObj.USE2_DESC_fieldList = ['TAXDATA_TPCLS2']
    countyObj.USE2_DESC_transferType = ''
    countyObj.USE3_DESC_fieldList = ['TAXDATA_TPCLS3']
    ...
    countyObj.OWNER_NAME_fieldList = ['TAXDATA_TAO_NAME']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = []
    countyObj.OWNER_MORE_transferType = ''
    countyObj.OWN_ADD_L1_fieldList = ['TAXDATA_ADDR_1']
    countyObj.OWN_ADD_L1_transferType = ''
    countyObj.OWN_ADD_L2_fieldList = ['TAXDATA_ADDR_2']
    countyObj.OWN_ADD_L2_transferType = ''
    countyObj.OWN_ADD_L3_fieldList = ['TAXDATA_ADDR_3']
    countyObj.OWN_ADD_L3_transferType = ''
    countyObj.OWN_ADD_L4_fieldList = ['TAXDATA_ADDR_4']
    ...
    countyObj.HOMESTEAD_fieldList = ['TAXDATA_TPHSTC']
    countyObj.HOMESTEAD_transferType = ''
    countyObj.TAX_YEAR_fieldList = ['TAXDATA_TAX_YR']
    countyObj.MARKET_YEAR_fieldList = ['TAXDATA_ASMT_YR']
    countyObj.EMV_LAND_fieldList = ['TAXDATA_LAND_EST']
    countyObj.EMV_BLDG_fieldList = ['TAXDATA_BUILDING']
    countyObj.EMV_TOTAL_fieldList = ['TAXDATA_ESTTOTVAL']
    countyObj.TAX_CAPAC_fieldList = []
    countyObj.TOTAL_TAX_fieldList = ['TAXDATA_TOT_TAX']
    countyObj.SPEC_ASSES_fieldList = ['TAXDATA_TOT_SPEC_ASMT']
    ...
    countyObj.SCHOOL_DST_fieldList = ['TAXDATA_SCH_DIST']
    ...
    countyObj.SECTION_fieldList = ['TAXDATA_SECT']
    countyObj.TOWNSHIP_fieldList = ['TAXDATA_TOWNSHIP']
    countyObj.RANGE_fieldList = ['TAXDATA_RANGE']
    countyObj.RANGE_DIR_fieldList = []
    countyObj.LEGAL_DESC_fieldList = ['TAXDATA_LEGAL']
    ...
    countyObj.ORIG_PIN_fieldList = ['TAX_PARCELS_PRINT_KEY']
