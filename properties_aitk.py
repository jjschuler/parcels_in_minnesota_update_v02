...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Aitkin'
        self.cty_fips = r'1'
        self.county_id = r'001'
        self.cty_abbr = r'AITK'
        ...
        self.PIN_exists.fieldTransferList = ['TAX_PARCELS_PRINT_KEY']
        ...
        self.CITY_exists.fieldTransferList = ['TAXDATA_Physical_City']
        ...
        self.PLAT_NAME_exists.fieldTransferList = ['TAXDATA_PLAT_DESC']
        ...
        self.ACRES_DEED_exists.fieldTransferList = ['TAXDATA_DEEDED_ACRES']
        self.USE1_DESC_exists.fieldTransferList = ['TAXDATA_TPCLS1']
        self.USE1_DESC_exists.transferType = ''
        self.USE2_DESC_exists.fieldTransferList = ['TAXDATA_TPCLS2']
        self.USE2_DESC_exists.transferType = ''
        self.USE3_DESC_exists.fieldTransferList = ['TAXDATA_TPCLS3']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['TAXDATA_TAO_NAME']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = []
        self.OWNER_MORE_exists.transferType = ''
        self.OWN_ADD_L1_exists.fieldTransferList = ['TAXDATA_ADDR_1']
        self.OWN_ADD_L1_exists.transferType = ''
        self.OWN_ADD_L2_exists.fieldTransferList = ['TAXDATA_ADDR_2']
        self.OWN_ADD_L2_exists.transferType = ''
        self.OWN_ADD_L3_exists.fieldTransferList = ['TAXDATA_ADDR_3']
        self.OWN_ADD_L3_exists.transferType = ''
        self.OWN_ADD_L4_exists.fieldTransferList = ['TAXDATA_ADDR_4']
        ...
        self.HOMESTEAD_exists.fieldTransferList = ['TAXDATA_TPHSTC']
        self.HOMESTEAD_exists.transferType = ''
        self.TAX_YEAR_exists.fieldTransferList = ['TAXDATA_TAX_YR']
        self.MARKET_YEAR_exists.fieldTransferList = ['TAXDATA_ASMT_YR']
        self.EMV_LAND_exists.fieldTransferList = ['TAXDATA_LAND_EST']
        self.EMV_BLDG_exists.fieldTransferList = ['TAXDATA_BUILDING']
        self.EMV_TOTAL_exists.fieldTransferList = ['TAXDATA_ESTTOTVAL']
        self.TAX_CAPAC_exists.fieldTransferList = []
        self.TOTAL_TAX_exists.fieldTransferList = ['TAXDATA_TOT_TAX']
        self.SPEC_ASSES_exists.fieldTransferList = ['TAXDATA_TOT_SPEC_ASMT']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['TAXDATA_SCH_DIST']
        ...
        self.SECTION_exists.fieldTransferList = ['TAXDATA_SECT']
        self.TOWNSHIP_exists.fieldTransferList = ['TAXDATA_TOWNSHIP']
        self.RANGE_exists.fieldTransferList = ['TAXDATA_RANGE']
        self.RANGE_DIR_exists.fieldTransferList = []
        self.LEGAL_DESC_exists.fieldTransferList = ['TAXDATA_LEGAL']
        ...
        self.ORIG_PIN_exists.fieldTransferList = ['TAX_PARCELS_PRINT_KEY']
