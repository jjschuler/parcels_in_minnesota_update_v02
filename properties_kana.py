...
def createCountyObj():
    ...
    countyObj.county_name = 'Kanabec'
    countyObj.cty_fips = r'65'
    countyObj.county_id = r'065'
    countyObj.cty_abbr = r'KANA'
    countyObj.mngeo_web_id = r'Kanabec 065'
    countyObj.sourceZipFile = r'KANA_parcels.zip'
    countyObj.sourcePolygons = r'Export_Output_7.shp'
    ...
    countyObj.OWNER_NAME_fieldList = ['OWNER_ORIG']
    countyObj.OWNER_NAME_transferType = ''
    countyObj.OWNER_MORE_fieldList = ['OWNER_PB']
