...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Kanabec'
        self.cty_fips = r'65'
        self.county_id = r'065'
        self.cty_abbr = r'KANA'
        self.mngeo_web_id = r'Kanabec 065'
        self.sourceZipFile = r'KANA_parcels.zip'
        self.sourcePolygons = r'Export_Output_7.shp'
        ...
        self.ACRES_POLY_exists.fieldTransferList = ['ACRES_CALC']
        ...
        self.OWNER_NAME_exists.fieldTransferList = ['OWNER_ORIG']
        self.OWNER_NAME_exists.transferType = ''
        self.OWNER_MORE_exists.fieldTransferList = ['OWNER_PB']
