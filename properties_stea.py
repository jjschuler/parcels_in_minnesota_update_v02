...
def createCountyObj():
    ...
    countyObj.county_name = 'Stearns'
    countyObj.cty_fips = r'145'
    countyObj.county_id = r'145'
    countyObj.cty_abbr = r'STEA'
    countyObj.mngeo_web_id = r'Stearns 145'
    countyObj.sourceZipFile = r'STEA_parcels.zip'
