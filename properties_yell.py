...
def createCountyObj():
    ...
    countyObj.county_name = 'Yellow Medicine'
    countyObj.cty_fips = r'173'
    countyObj.county_id = r'173'
    countyObj.cty_abbr = r'YELL'
    countyObj.mngeo_web_id = r'Yellow Medicine 173'
    countyObj.sourceZipFile = r'YELL_parcels.zip'
