...
def createCountyObj():
    ...
    countyObj.county_name = 'Wright'
    countyObj.cty_fips = r'171'
    countyObj.county_id = r'171'
    countyObj.cty_abbr = r'WRIG'
    countyObj.mngeo_web_id = r'Wright 171'
    countyObj.sourceZipFile = r'WRIG_parcels.zip'
    ...
    countyObj.BLDG_NUM_fieldList = ['PropHouse']
    countyObj.BLDG_NUM_transferType = ''
    countyObj.PREFIX_DIR_fieldList = ['PropHsSuf']
    countyObj.PREFIX_DIR_transferType = ''
    countyObj.PREFIXTYPE_fieldList = []
    countyObj.PREFIXTYPE_transferType = ''
    countyObj.STREETNAME_fieldList = ['PropStr']
    countyObj.STREETNAME_transferType = ''
    countyObj.STREETTYPE_fieldList = ['PropStrTyp']
    countyObj.STREETTYPE_transferType = ''
    countyObj.SUFFIX_DIR_fieldList = ['PropStrDir']
    countyObj.SUFFIX_DIR_transferType = ''
    countyObj.UNIT_INFO_fieldList = ['PropUnit']
    countyObj.UNIT_INFO_transferType = ''
    countyObj.CITY_fieldList = ['PropCity']
    ...
    countyObj.TAX_NAME_fieldList = ['TPSortName']
    countyObj.TAX_NAME_transferType = ''
    countyObj.TAX_ADD_L1_fieldList = ['TPAddr1']
    countyObj.TAX_ADD_L1_transferType = ''
    countyObj.TAX_ADD_L2_fieldList = ['TPAddr2']
    countyObj.TAX_ADD_L2_transferType = ''
    countyObj.TAX_ADD_L3_fieldList = ['TPAddr3']
    countyObj.TAX_ADD_L3_transferType = ''
    countyObj.TAX_ADD_L4_fieldList = ['TPCity', 'TPState', 'TPZip']
    ...
    countyObj.EMV_LAND_fieldList = ['SumMVLand']
    countyObj.EMV_BLDG_fieldList = ['SumMVBldg']
    ...
    countyObj.FIN_SQ_FT_fieldList = ['SQ_FT']
    ...
    countyObj.SALE_VALUE_fieldList = ['SALPRICE']
