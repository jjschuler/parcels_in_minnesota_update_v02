...
class countyEtl(countyEtlParams):
    ...
    def __init__(self):
        self.county_name = 'Chisago'
        self.cty_fips = r'25'
        self.county_id = r'025'
        self.cty_abbr = r'CHIS'
        self.mngeo_web_id = r'Chisago 025'
        self.sourceZipFile = r'CHIS_parcels.zip'
        ...
        self.ACRES_DEED_exists.fieldTransferList = ['DeedAcre']
        ...
        self.OWN_ADD_L1_exists.fieldTransferList = ['PropAddr', 'PropUnit']
        self.OWN_ADD_L1_exists.transferType = 'concatTruncateTwoFields'
        self.OWN_ADD_L2_exists.fieldTransferList = ['PropCity', 'PropZip']
        ...
        self.TAX_ADD_L1_exists.fieldTransferList = ['MailAddr']
        self.TAX_ADD_L1_exists.transferType = ''
        self.TAX_ADD_L2_exists.fieldTransferList = ['MailCity', 'MailZip']
        ...
        self.EMV_LAND_exists.fieldTransferList = ['LandValue']
        self.EMV_BLDG_exists.fieldTransferList = ['BldgValue']
        self.EMV_TOTAL_exists.fieldTransferList = ['TotalValue']
        ...
        self.SCHOOL_DST_exists.fieldTransferList = ['School']
        ...
        self.LEGAL_DESC_exists.fieldTransferList = ['LegalDesc']
