...
def createCountyObj():
    ...
    countyObj.county_name = 'Chisago'
    countyObj.cty_fips = r'25'
    countyObj.county_id = r'025'
    countyObj.cty_abbr = r'CHIS'
    countyObj.mngeo_web_id = r'Chisago 025'
    countyObj.sourceZipFile = r'CHIS_parcels.zip'
    ...
    countyObj.ACRES_DEED_fieldList = ['DeedAcre']
    ...
    countyObj.OWN_ADD_L1_fieldList = ['PropAddr', 'PropUnit']
    countyObj.OWN_ADD_L1_transferType = 'concatTruncateTwoFields'
    countyObj.OWN_ADD_L2_fieldList = ['PropCity', 'PropZip']
    countyObj.OWN_ADD_L2_transferType = 'concatTruncateTwoFields'
    ...
    countyObj.TAX_ADD_L1_fieldList = ['MailAddr']
    countyObj.TAX_ADD_L1_transferType = 'defaultTransfer'
    countyObj.TAX_ADD_L2_fieldList = ['MailCity', 'MailZip']
    ...
    countyObj.EMV_LAND_fieldList = ['LandValue']
    countyObj.EMV_BLDG_fieldList = ['BldgValue']
    countyObj.EMV_TOTAL_fieldList = ['TotalValue']
    ...
    countyObj.SCHOOL_DST_fieldList = ['School']
