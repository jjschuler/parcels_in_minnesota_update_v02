...
def createCountyObj():
    ...
    countyObj.county_name = 'Polk'
    countyObj.cty_fips = r'119'
    countyObj.county_id = r'119'
    countyObj.cty_abbr = r'POLK'
    countyObj.mngeo_web_id = r'Polk 119'
    countyObj.sourceZipFile = r'Polk_parcels.zip'
    countyObj.sourcePolygons = r'Polk_GIS_DBO_Parcels.shp'
