...
def createCountyObj():
    ...
    countyObj.county_name = 'Carver'
    countyObj.cty_fips = r'19'
    countyObj.county_id = r'019'
    countyObj.cty_abbr = r'CARV'
    countyObj.mngeo_web_id = r'Carver 019'
    countyObj.sourceZipFile = r'CARV_parcels.zip'
